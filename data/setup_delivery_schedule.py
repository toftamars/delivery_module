...
def setup_delivery_schedule(env):
    ...
    monday = env.ref('delivery_module.tofta_delivery_day_monday')
    tuesday = env.ref('delivery_module.tofta_delivery_day_tuesday')
    wednesday = env.ref('delivery_module.tofta_delivery_day_wednesday')
    thursday = env.ref('delivery_module.tofta_delivery_day_thursday')
    friday = env.ref('delivery_module.tofta_delivery_day_friday')
    saturday = env.ref('delivery_module.tofta_delivery_day_saturday')
    
    print(f"Teslimat günleri bulundu: {monday.name}, {tuesday.name}, {wednesday.name}, {thursday.name}, {friday.name}, {saturday.name}")
    
    # İlçeleri al
    # Anadolu Yakası
    maltepe = env.ref('delivery_module.tofta_district_maltepe')
    kartal = env.ref('delivery_module.tofta_district_kartal')
    pendik = env.ref('delivery_module.tofta_district_pendik')
    tuzla = env.ref('delivery_module.tofta_district_tuzla')
    uskudar = env.ref('delivery_module.tofta_district_uskudar')
    kadikoy = env.ref('delivery_module.tofta_district_kadikoy')
    atasehir = env.ref('delivery_module.tofta_district_atasehir')
    umraniye = env.ref('delivery_module.tofta_district_umraniye')
    sancaktepe = env.ref('delivery_module.tofta_district_sancaktepe')
    cekmekoy = env.ref('delivery_module.tofta_district_cekmekoy')
    beykoz = env.ref('delivery_module.tofta_district_beykoz')
    sile = env.ref('delivery_module.tofta_district_sile')
    sultanbeyli = env.ref('delivery_module.tofta_district_sultanbeyli')
    
    # Avrupa Yakası
    beyoglu = env.ref('delivery_module.tofta_district_beyoglu')
    sisli = env.ref('delivery_module.tofta_district_sisli')
    besiktas = env.ref('delivery_module.tofta_district_besiktas')
    kagithane = env.ref('delivery_module.tofta_district_kagithane')
    sariyer = env.ref('delivery_module.tofta_district_sariyer')
    bakirkoy = env.ref('delivery_module.tofta_district_bakirkoy')
    bahcelievler = env.ref('delivery_module.tofta_district_bahcelievler')
    gungoren = env.ref('delivery_module.tofta_district_gungoren')
    esenler = env.ref('delivery_module.tofta_district_esenler')
    bagcilar = env.ref('delivery_module.tofta_district_bagcilar')
    eyupsultan = env.ref('delivery_module.tofta_district_eyupsultan')
    gaziosmanpasa = env.ref('delivery_module.tofta_district_gaziosmanpasa')
    kucukcekmece = env.ref('delivery_module.tofta_district_kucukcekmece')
    avcilar = env.ref('delivery_module.tofta_district_avcilar')
    basaksehir = env.ref('delivery_module.tofta_district_basaksehir')
    sultangazi = env.ref('delivery_module.tofta_district_sultangazi')
    arnavutkoy = env.ref('delivery_module.tofta_district_arnavutkoy')
    fatih = env.ref('delivery_module.tofta_district_fatih')
    zeytinburnu = env.ref('delivery_module.tofta_district_zeytinburnu')
    bayrampasa = env.ref('delivery_module.tofta_district_bayrampasa')
    esenyurt = env.ref('delivery_module.tofta_district_esenyurt')
    beylikduzu = env.ref('delivery_module.tofta_district_beylikduzu')
    silivri = env.ref('delivery_module.tofta_district_silivri')
    catalca = env.ref('delivery_module.tofta_district_catalca')
